...
Then just `import from edinbustrack *` to load it into your project. Obviously depending on the layout of your project and subfolders you may have to slightly modify this import statement.
